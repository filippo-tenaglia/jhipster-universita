...
export class StudenteComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.studenteService
            ...
            .subscribe(
                (res: HttpResponse<IStudente[]>) => this.paginateStudenti(res.body, res.headers),
    ...
    protected paginateStudenti(data: IStudente[], headers: HttpHeaders) {
